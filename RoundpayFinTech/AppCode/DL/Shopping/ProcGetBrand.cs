...
namespace RoundpayFinTech.AppCode.DL
{
	...
	public class ProcGetBrandById : IProcedure
	{
		...
		public object Call() => throw new NotImplementedException();
		public string GetName() => @"SELECT b._ID, b._BrandName, b._CategoryID, c._CategoryName, b._IsActive FROM Master_Brand b left outer join Master_ShoppingCategory c on c._ID = b._CategoryID where (b._ID=@BrandId or @BrandId = 0)";
	}
}
