...
namespace RoundpayFinTech.AppCode.Interfaces
{
    interface IAlertML
    {
        ...
        IResponseStatus LowBalanceSMS(AlertReplacementModel param, SMSSetting smsSetting);
        IResponseStatus LowBalanceEmail(AlertReplacementModel param, EmailSettingswithFormat mailSetting);
        IResponseStatus LowBalanceNotification(AlertReplacementModel param);
        #endregion
