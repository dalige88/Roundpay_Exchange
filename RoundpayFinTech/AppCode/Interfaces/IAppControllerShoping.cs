...
namespace RoundpayFinTech.AppCode.Interfaces
{
    public interface IAppControllerShoping
    {
        ...
        Task<IActionResult>  ProceedToPay([FromBody] AppSessionReq appRequest);
        ...
        Task<IActionResult> GetShippingAddresses([FromBody] AppSessionReq appRequest);
        ...
        Task<IActionResult> GetStates([FromBody] AppRequest appRequest);
