...
namespace RoundpayFinTech.AppCode.Interfaces
{
    public interface IDeviceML
    {
        ...
        Task<BalanceEquiryResp> CheckBalance(PidData pidData, string aadhar, string bank, int _InterfaceType, int UserID, int OutletID,int RMode,int OID, string IMEI, string Lattitude, string Longitude);
        ...
        Task<WithdrawlResponse> Withdrawl(PidData pidData, string aadhar, string bank, int _InterfaceType, int Amount, int UserID, int OutletID, int RMode, int OID, string IMEI, string Lattitude, string Longitude);
        Task<WithdrawlResponse> Aadharpay(PidData pidData, string aadhar, string bank, int _InterfaceType, int Amount, int UserID, int OutletID, int RMode, int OID, string IMEI, string Lattitude, string Longitude);
        ...
        MiniStatementResponse MiniStatement(PidData pidData, string aadhar, string Bank, string BankIIN, int _InterfaceType, int UserID, int OutletID, int RMode, int OID, string SPKey, string IMEI, string Lattitude, string Longitude);
