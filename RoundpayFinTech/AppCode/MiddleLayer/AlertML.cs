...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class AlertML : BaseML, IAlertML
    {
        ...
        public IResponseStatus LowBalanceSMS(AlertReplacementModel param, SMSSetting smsSetting)
        {
            var _res = new ResponseStatus
            {
                Statuscode = ErrorCodes.One,
        ...
        public IResponseStatus LowBalanceEmail(AlertReplacementModel param, EmailSettingswithFormat mailSetting)
        {
            bool IsSent = false;
            var _res = new ResponseStatus
            {
        ...
        public IResponseStatus LowBalanceNotification(AlertReplacementModel param)
        {
            var _res = new ResponseStatus
            {
                Statuscode = ErrorCodes.One,
