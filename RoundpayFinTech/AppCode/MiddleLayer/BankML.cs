...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class BankML : IBankML
    {
        ...
        public BankMaster BankMaster(int ID)
        {
            ...
            if (_lr.LoginTypeID == LoginType.ApplicationUser && !userML.IsEndUser())
            {
                ...
                bankmaster = ((List<BankMaster>)_proc.Call(_lr.UserID)).First();
            }
            return bankmaster;
        }
        ...
        public IResponseStatus Delete(int bankId, int userId, int loginTypeId)
        {
            ...
            var res = (IResponseStatus)_proc.Call(commonReq);
            return res;
        }
