...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class DeviceML : IDeviceML
    {
        ...
        public async Task<BalanceEquiryResp> CheckBalance(string _pidData, string aadhar, string bank, int _InterfaceType, int OID, string IMEI, string Lattitude, string Longitude)
        {
            ...
            if (usersDataForAEPS.Statuscode == ErrorCodes.One)
            {
                ...
                if (usersDataForAEPS.APICode == APICode.FINGPAY)
                {
                    ...
                    DeviceLog(APICode.FINGPAY, "GetBalance", response.Req, response.Resp);
        ...
        public async Task<BalanceEquiryResp> CheckBalance(PidData pidData, string aadhar, string bank, int _InterfaceType, int UserID, int OutletID, int RMode, int OID, string IMEI, string Lattitude, string Longitude)
        {
            var response = new BalanceEquiryResp
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public async Task<WithdrawlResponse> Withdrawl(string _pidData, string aadhar, string bank, int _InterfaceType, int Amount, int OID, string IMEI, string Lattitude, string Longitude)
        {
            ...
            if (usersDataForAEPS.Statuscode == ErrorCodes.One)
            {
                ...
                if (usersDataForAEPS.APICode == APICode.FINGPAY)
                {
                    ...
                    DeviceLog(APICode.FINGPAY, "Withdrawl", response.Req, response.Resp);
        ...
        public async Task<WithdrawlResponse> Withdrawl(PidData pidData, string aadhar, string bank, int _InterfaceType, int Amount, int UserID, int OutletID, int RMode, int OID, string IMEI, string Lattitude, string Longitude)
        {
            var response = new WithdrawlResponse
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public async Task<WithdrawlResponse> Aadharpay(PidData pidData, string aadhar, string bank, int _InterfaceType, int Amount, int UserID, int OutletID, int RMode, int OID, string IMEI, string Lattitude, string Longitude)
        {
            var response = new WithdrawlResponse
            {
                Statuscode = ErrorCodes.Minus1,
            ...
            if (usersDataForAEPS.Statuscode == ErrorCodes.One)
            {
                ...
                if (usersDataForAEPS.APICode == APICode.FINGPAY)
                {
                    ...
                    DeviceLog(APICode.FINGPAY, "Aadharpay", response.Req, response.Resp);
                    response.TransactionID = aepsTranResp.TransactionID;
                }
                if (response.Status.In(RechargeRespType.PENDING, RechargeRespType.SUCCESS, RechargeRespType.FAILED))
                {
        ...
        public MiniStatementResponse MiniStatement(PidData pidData, string aadhar, string Bank, string BankIIN, int _InterfaceType, int UserID, int OutletID, int RMode, int OID, string SPKey, string IMEI, string Lattitude, string Longitude)
        {
            ...
            if (usersDataForAEPS.Statuscode == ErrorCodes.One)
            {
                ...
                if (usersDataForAEPS.APICode == APICode.FINGPAY)
                {
                    ...
                    DeviceLog(APICode.FINGPAY, "MiniStatement", response.Req, response.Resp);
