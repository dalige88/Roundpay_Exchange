...
namespace RoundpayFinTech.AppCode.MiddleLayer.Dmt_Api
{
    public partial class ICICIPayoutML
    {
        ...
        public CollectUPPayResponse CollectPayRequestWeb(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
        ...
        public CollectUPPayResponse CollectPayRequestApp(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new CollectUPPayResponse
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public CollectUPPayResponse CollectPayRequestAppQR(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new CollectUPPayResponse
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public CollectUPPayResponse CollectPayStatusCheckWeb(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new CollectUPPayResponse
            {
        ...
        public CollectUPPayResponse CollectPayStatusCheckApp(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new CollectUPPayResponse
            {
                Statuscode = RechargeRespType.PENDING,
        ...
        public CollectUPPayResponse CollectPayCallbackStatusCheck(ColllectUPPayReqModel request, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new CollectUPPayResponse
            {
                Statuscode = RechargeRespType.PENDING,
