...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class FintechShoppingML : IFintechShoppingML
    {
        ...
        public IEnumerable<ShoppingMenu> GetShoppingMenu()
        {
            ...
            var Category = mL.GetShoppingCategory().Where(lst => lst.ProductCount > 0);
            var subCategoryLvl1 = mL.GetSubCategoryLvl1(0).Where(lst => lst.ProductCount > 0);
            var subCategoryLvl2 = mL.GetSubCategoryLvl2(0).Where(lst => lst.ProductCount > 0);
            ...
            foreach (var item in subCategoryLvl1)
            {
                MenuLevel1.Add(new MenuLevel1
                {
                    ...
                    MenuLevel2 = subCategoryLvl2.Where(x => x.SubCategoryID == item.SubCategoryID && x.CategoryID == item.CategoryID),
            ...
            foreach (var item in Category)
            {
                Menu.Add(new ShoppingMenu
                {
                    ...
                    MenuLevel1 = MenuLevel1.Where(x => x.CategoryID == item.CategoryID),
