                    ...
                    if (fintechResp.data != null)
                    {
                        if (fintechResp.data.billerList.Count > 0)
                        {
                            ...
                            if (readyToSave.Count > 0)
                            {
                                foreach (var item in readyToSave)
                                {
                                    var tempOID = resList.Where(x => x.ReffID == item.RPBillerID).Select(x => x.CommonInt).ToList()[0];
                                    var procUpdateReq = new BillerInfoUpdateModel
                                    {
                                        OID = tempOID,
                                        LoginID = _lr.UserID,
                                    ...
                                    var opParams = fintechResp.data.billerParamList.Where(w => w.OID == tempOID).ToList();
                                    if (opParams != null)
                                    {
                                        if (opParams.Count > 0)
                                        {
                                    ...
                                    var paymentChannelsAllowed = fintechResp.data.billerPaymentChanel.Where(w => w.OID == tempOID).ToList();
                                    if (paymentChannelsAllowed != null)
                                    {
                                        if (paymentChannelsAllowed.Count > 0)
                                        {
                    ...
                    foreach (var ccd in data.CircleCodes)
                    {
                        if (!string.IsNullOrEmpty(ccd.CircleCode))
                        {
                                    ...
                                    try
                                    {
                                        if (plans.Records != null)
                                        {
                                            if (plans.Records.TwoG != null)
                                            {
                                                ...
                                                {
                                                    dtAllPlans.Rows.Add(OID, ccd.CircleID, rid[0].ID, comboItem.rs, comboItem.validity, comboItem.desc, DateTime.Now, DateTime.Now, APIID);
                                            ...
                                            if (plans.Records.HotStar != null)
                                            {
                                                ...
                                                {
                                                    dtAllPlans.Rows.Add(OID, ccd.CircleID, rid[0].ID, comboItem.rs, comboItem.validity, comboItem.desc, DateTime.Now, DateTime.Now);
                            ...
                            else if (data.APICode.Equals(PlanType.MPLAN))
                            {
                                resp = AppWebRequest.O.CallUsingHttpWebRequest_GET(sb.ToString());
                                IProcedureAsync _err = new ProcLogPlansAPIReqResp(_dal);
                                resp = "{\"records\":{\"TOPUP\":[{\"rs\":\"10\",\"desc\":\"Talktime : Rs 7.47 Talktime Validity Unrestricted, No service validity available with this talktime pack \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"20\",\"desc\":\"Talktime : Rs 14.95 Talktime Validity Unrestricted, No service validity available with this talktime pack \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"30\",\"desc\":\"Talktime : Rs 22.42 Talktime Validity Unrestricted, No service validity available with this talktime pack \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"50\",\"desc\":\"Talktime : Rs 39.37 Talktime Validity Unrestricted, No service validity available with this talktime pack \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"100\",\"desc\":\"Talktime of Rs. 81.75, No Outgoing SMS. Talktime validity - Unrestricted \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"500\",\"desc\":\"Talktime : Rs 423.73 Talktime Validity Unrestricted \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"1000\",\"desc\":\"Talktime : Rs 847.46 Talktime Validity Unrestricted \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"5000\",\"desc\":\"Talktime : Rs 4237.29 Talktime Validity Unrestricted \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"}],\"3G 4G\":[{\"rs\":\"16\",\"desc\":\"Get 1GB Data for 24 hrs and enjoy Movies & TV shows in our App. Applicable only for prepaid subscribers. No service validity \",\"validity\":\"1 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"48\",\"desc\":\"3GB Data; Pack validity - 28 days, No Service Validity \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"51\",\"desc\":\"Rs1000 Day Hospicare cover.10Days at a time, 30 Days yr. 1 GB data, No Outgoing SMS. Validity for 28Days. Zero Talktime.No Service validity. For 18-55yrs with sound health in non-hazardous jobs. Insurance as per name in VIL records. TnC. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"98\",\"desc\":\"6+6 = 12GB Data. No Outgoing SMS. Pack Valid for 28 days. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"251\",\"desc\":\"50GB Data Pack validity for 28 days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"351\",\"desc\":\"100GB Data Pack validity for 56 days \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"601\",\"desc\":\"Binge Nonstop all year-LIVE T20 action, Hotstar Specials, Multiplex Movies with 1yr Disney+ Hotstar Mobile subscription + 75GB Data for 56 Days. No Service Validity. \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"}],\"RATE CUTTER\":[{\"rs\":\"18\",\"desc\":\"US_CANADA_1Hour UL Calling \",\"validity\":\"1 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"19\",\"desc\":\"Get Truly Unlimited Calls , 200 MB data for 2 days No service Validity \",\"validity\":\"N A\",\"last_update\":\"09-10-2021\"},{\"rs\":\"24\",\"desc\":\"Plan Voucher - Call rate of 2.5p sec, 100 on-net night minutes for 14 days\",\"validity\":\"14 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"27\",\"desc\":\"Enjoy ISD Tariff at USA, Canada, UK Fixed - 2p sec , China - 3p sec (International Calls) Service Validity for 28 Days\",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"49\",\"desc\":\"Rs 38 Limited validity talktime, Calls at 2.5p sec, 100 MB Data. No Outgoing SMS. 14 Day Service Validity. \",\"validity\":\"14 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"79\",\"desc\":\"Get Rs 64 Limited Validity Talktime, Local National Calls at 1p sec and 200 MB Data. No Outgoing SMS. Pack Valid for 28 Days. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"95\",\"desc\":\"Rs 74 Limited validity talktime, Calls at 2.5p sec and 200 MB Data; No Outgoing SMS. 35 Day Service Validity \",\"validity\":\"35 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"128\",\"desc\":\"Get 10 Local On-net Night Minutes + All Local National Calls at 2.5 paise sec. Night minutes benefit available from 2300 Hrs to 0600 Hrs. Outgoing SMS @ Rs 1 1.5 5 for Local STD ISD. Pack valid for 28 Days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"}],\"2G\":[{\"rs\":\"16\",\"desc\":\"Get 1GB Data for 24 hrs and enjoy Movies & TV shows in our App. Applicable only for prepaid subscribers. No service validity \",\"validity\":\"1 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"51\",\"desc\":\"Rs1000 Day Hospicare cover.10Days at a time, 30 Days yr. 1 GB data, No Outgoing SMS. Validity for 28Days. Zero Talktime.No Service validity. For 18-55yrs with sound health in non-hazardous jobs. Insurance as per name in VIL records. TnC. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"98\",\"desc\":\"6+6 = 12GB Data. No Outgoing SMS. Pack Valid for 28 days. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"251\",\"desc\":\"50GB Data Pack validity for 28 days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"351\",\"desc\":\"100GB Data Pack validity for 56 days \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"}],\"SMS\":[{\"rs\":\"299\",\"desc\":\"Get 2GB Day, Unlimited Calls + 100 SMS Day. Pack Validity- 28 Days. Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri unused data into Sat-Sun. At NO Extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"399\",\"desc\":\"Get 1.5 GB Day + Unlimited Calls + 100 SMS Day valid for 56 Days.Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"449\",\"desc\":\"Get 2GB Day, Unlimited Calls + 100 SMS Day. Pack Validity- 56 Days. Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri unused data into Sat-Sun. At NO Extra cost! Also get Vi Movies & TV Classic access \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"599\",\"desc\":\"Get 1.5 GB Day + Unlimited Calls + 100 SMS Day valid for 84 Days.Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access \",\"validity\":\"84 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"699\",\"desc\":\"Get 2GB Day, Unlimited Calls + 100 SMS Day. Pack Validity- 84 Days. Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri unused data into Sat-Sun. At NO Extra cost! Also get Vi Movies & TV Classic access \",\"validity\":\"84 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"1197\",\"desc\":\"Get 1.5GB Day + Unlimited Calls + 100 SMS Day. Pack Validity - 180 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"180 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"2399\",\"desc\":\"Get 1.5GB Day + Unlimited Calls + 100 SMS Day. Pack Validity - 365 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"365 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"2595\",\"desc\":\"1yr Disney+ Hotstar Mobile subscription; 1.5 GB Day + Unlimited Calls + 100 SMS Day. Pack Validity - 365 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"365 days\",\"last_update\":\"09-10-2021\"}],\"Romaing\":[{\"rs\":\"32\",\"desc\":\"Get access to Over 200 Popular Ad-free Games for 28 Days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"42\",\"desc\":\"Get Unlimited SMS score alerts for on-going Cricket match and Chance to talk to Sports celebrity (Min 5 event in a month). Pack validity 28 Days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"43\",\"desc\":\"Recharge with Contest Pack and get a chance to win Recharges, Gold Voucher & more every week. Validity 28 Days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"47\",\"desc\":\"Caller tunes With Unlimited Song Change at Rs. 47 for 28 days. No Service Validity \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"52\",\"desc\":\"Now Enjoy Live Chat with Bollywood celebrity, (Min 5 event in a month), Pack validity 28 Days \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"62\",\"desc\":\"Get access to Over 200 Popular Ad-free Games for 89 Days \",\"validity\":\"89 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"72\",\"desc\":\"Get Unlimited SMS score alerts for on-going Cricket match and Chance to talk to Sports celebrity (Min 5 event in a month). Pack validity 89 Days \",\"validity\":\"89 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"73\",\"desc\":\"Recharge with Contest Pack and get a chance to win Recharges, Gold Voucher & more every week. Validity 89 Days \",\"validity\":\"89 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"78\",\"desc\":\"Caller tunes With Unlimited Song Change at Rs. 78 for 89 days. No Service Validity \",\"validity\":\"89 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"103\",\"desc\":\"Now Enjoy Live Chat with Bollywood celebrity, (Min 5 event in a month), Pack validity 89 Days \",\"validity\":\"89 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"295\",\"desc\":\"40 mins of international roaming calls which include Outgoing local calls, calls back to India and Incoming Calls only. Applicable in USA, UAE, Singapore, Thailand, UK, Sri Lanka, China, Saudi Arabia, Qatar, Oman, Bahrain, Kuwait, Nepal, Bangladesh, Indonesia, Malaysia, Australia, NZ, Canada & many more! Validity: 28 days. T&C Apply \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"695\",\"desc\":\"In 23 countries including the US, UAE, Singapore, Thailand, Malaysia, UK, New Zealand & more destinations enjoy FREE data up to 1GB (Rs.1 MB after 1GB) FREE SMS & FREE incoming calls. Plus 120mins FREE outgoing calls(local & to India), after 120 mins Re.1 min. In 45 other countries, Enjoy 300MB data (Re.1 MB after 300MB) & 10 Free SMS (Re.1 SMS after 10SMS). Also enjoy FREE incoming calls with 50mins FREE outgoing calls(local & to India), after 50 mins Re.1 min. Standard roaming rates apply for Outgoing calls to other countries \",\"validity\":\"1 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"995\",\"desc\":\"Get FREE 150 min outgoing & incoming calls & 500 MB when roaming abroad in US, UK, Singapore, Thailand, Malaysia, Bangladesh, Sri Lanka, China, Kenya, Germany, Belgium, Turkey, Netherlands & more! Also, get FREE 100 min & 100 MB when roaming in UAE, Saudi Arabia, Qatar, Oman, Kuwait, Bahrain, Afghanistan, Nepal, Indonesia, Russia, Egypt. Validity: 7 days. T&C Apply \",\"validity\":\"7 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"1495\",\"desc\":\"Get FREE 300 min outgoing & incoming calls & 1GB when roaming abroad in US, UK, Singapore, Thailand, Malaysia, Europe (Germany, Belgium, France, Netherlands, Italy, Spain, Greece), Australia, NZ, Bangladesh, China, Turkey & more! Also, get FREE 150 min & 250 MB when roaming in UAE, Saudi Arabia, Qatar, Oman, Kuwait, Bahrain, Afghanistan, Nepal, Indonesia, Russia, Egypt. Validity: 14 days. T&C Apply \",\"validity\":\"14 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"2695\",\"desc\":\"In 23 countries including the US, UAE, Singapore, Thailand, Malaysia, UK, New Zealand & more destinations enjoy FREE data up to 4GB (Rs.1 MB after 4GB) FREE SMS & FREE incoming calls. Plus 120mins day FREE outgoing calls(local & to India), after 120 mins Re.1 min. In 45 other countries, enjoy 1.2GB data (Re.1 MB after 1.2GB) & 40 Free SMS (Re.1 SMS after 40SMS). Also enjoy FREE incoming calls with 200mins FREE outgoing calls(local & to India), after 200 mins Re.1 min. Standard roaming rates apply for Outgoing calls to other countries \",\"validity\":\"4 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"3495\",\"desc\":\"In 23 countries including the US, UAE, Singapore, Thailand, Malaysia, UK, New Zealand & more destinations enjoy FREE data up to 7GB (Rs.1 MB after 7GB) FREE SMS & FREE incoming calls. Plus 120mins day FREE outgoing calls(local & to India), after 120 mins Re.1 min. In 45 other countries, enjoy 2GB data (Re.1 MB after 2GB) & 25 Free SMS (Re.1 SMS after 25SMS). Also enjoy FREE incoming calls with 200mins FREE outgoing calls(local & to India), after 200 mins Re.1 min. Standard roaming rates apply for Outgoing calls to other countries \",\"validity\":\"7 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"4695\",\"desc\":\"In 23 countries including the US, UAE, Singapore, Thailand, Malaysia, UK, New Zealand & more destinations enjoy FREE data up to 10GB (Rs.1 MB after 10GB) FREE SMS & FREE incoming calls. Plus 120mins day FREE outgoing calls(local & to India), after 120 mins Re.1 min. In 45 other countries, enjoy 3GB data (Re.1 MB after 3GB) & 50 Free SMS (Re.1 SMS after 50SMS). Also enjoy FREE incoming calls with 300mins FREE outgoing calls(local & to India), after 300 mins Re.1 min. Standard roaming rates apply for Outgoing calls to other countries \",\"validity\":\"10 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"6995\",\"desc\":\"In 23 countries including the US, UAE, Singapore, Thailand, Malaysia, UK, New Zealand & more destinations enjoy FREE data up to 15GB (Rs.1 MB after 15GB) FREE SMS & FREE incoming calls. Plus 120mins day FREE outgoing calls(local & to India), after 120 mins Re.1 min. In 45 other countries, enjoy 5GB data (Re.1 MB after 5GB) & 100 Free SMS (Re.1 SMS after 100SMS). Also enjoy FREE incoming calls with 500mins FREE outgoing calls(local & to India), after 500 mins Re.1 min. Standard roaming rates apply for Outgoing calls to other countries \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"}],\"COMBO\":[{\"rs\":\"99\",\"desc\":\"Get Unlimited Calls + 200 MB Data. No Outgoing SMS. Pack Validity - 18 Days. \",\"validity\":\"18 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"109\",\"desc\":\"Get Unlimited Calls + 1GB Data. No Outgoing SMS. Pack Validity - 20 Days \",\"validity\":\"20 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"129\",\"desc\":\"Get Unlimited Calls + 1 GB Data + 300 SMS. Pack Validity - 24 Days \",\"validity\":\"24 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"149\",\"desc\":\"Get Unlimited Calls + 2GB Data + 300 SMS. Pack Validity - 28 Days; Vi Movies & TV Basic access. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"199\",\"desc\":\"Get 1GB day + Unlimited Calls + 100 SMS day for 24 days; Vi Movies & TV Basic access. \",\"validity\":\"24 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"219\",\"desc\":\"Get 1GB Day + Unlimited Calls + 100 SMS Day. Pack Validity - 28 Days; Also get Vi Movies & TV Basic access. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"249\",\"desc\":\"Get 1.5 GB Day + Unlimited Calls + 100 SMS Day valid for 28 Days.Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"267\",\"desc\":\"Get Truly Unlimited Local National Calls to all Networks + 25 GB Data + 100 SMS day. Pack Valid for 30 Days; Vi Movies & TV Classic access \",\"validity\":\"30 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"269\",\"desc\":\"Get Unlimited Calls + 4GB Data + 600 SMS. Pack Validity - 56 Days; Vi Movies & TV Basic access. \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"301\",\"desc\":\"Get 1.5 GB Day + Unlimited Calls + 100 SMS Day. Pack Validity-28Days; Rs1000 Day Hospicare cover by Aditya Birla Health Insurance. 10Days at a time, upto 30Days yr. For 18-55yrs with sound health in non-hazardous jobs.Insurance in the name in VIL records. TnC; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access.\",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"379\",\"desc\":\"Get Unlimited Calls + 6GB Data + 1000 SMS. Pack Validity for 84 Days; Vi Movies & TV Basic access. \",\"validity\":\"84 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"447\",\"desc\":\"Get Truly Unlimited Local National Calls to all Networks + 50 GB Data + 100 SMS day. Pack Valid for 60 Days; Vi Movies & TV Classic access. \",\"validity\":\"60 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"499\",\"desc\":\"1.5 GB Day + Unlimited Calls + 100 SMS Day valid for 70 Days.Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access \",\"validity\":\"70 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"501\",\"desc\":\"1 year Disney+ Hotstar Mobile subscription; 3GB Day + 16GB EXTRA + Unlimited Calls + 100 SMS Day for 28 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV VIP access. \",\"validity\":\"28 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"555\",\"desc\":\"1.5 GB Day + Unlimited Calls + 100 SMS Day valid for 77 Days.Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri`s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV Classic access \",\"validity\":\"77 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"701\",\"desc\":\"1 year Disney+ Hotstar Mobile subscription; 3GB Day + 32GB EXTRA + Unlimited Calls + 100 SMS Day for 56 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV VIP access. \",\"validity\":\"56 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"901\",\"desc\":\"1 year Disney+ Hotstar Mobile subscription; 3GB Day + 48GB EXTRA + Unlimited Calls + 100 SMS Day for 84 Days; Enjoy Night data without limits from 12am to 6am! Carry Mon-Fri s unused data into Sat-Sun. At NO extra cost! Also get Vi Movies & TV VIP access. \",\"validity\":\"84 days\",\"last_update\":\"09-10-2021\"},{\"rs\":\"1499\",\"desc\":\"Get Unlimited Calls + 24GB Data + 3600 SMS. Pack Validity for 365 Days; Also get Vi Movies & TV Basic access. \",\"validity\":\"365 days\",\"last_update\":\"09-10-2021\"}]},\"status\":1,\"time\":0.009225130081176758}";
                                _err.Call(new CommonReq
                                {
                                    CommonStr = "BulkInsertion | " + data.APICode + " | " + ccd.CircleCode,
                                    CommonStr2 = sb.ToString(),
