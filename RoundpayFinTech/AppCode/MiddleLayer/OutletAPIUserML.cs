...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public partial class APIUserML : IOutletAPIUserMiddleLayer
    {
        ...
        public ServiceResponse CheckOutletServiceStatus(APIRequestOutlet aPIRequest)
        {
            ...
            var onboadresp = bbpsML.CheckOutletStatusForServices(LoginType.ApplicationUser, aPIRequest.UserID, validateRes.OID, aPIRequest.data.OutletID, string.Empty, aPIRequest.data.OTP, RequestMode.API, aPIRequest.PartnerID, aPIRequest.Token);
