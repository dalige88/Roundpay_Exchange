...
namespace RoundpayFinTech.AppCode.MiddleLayer
{
    public class SellerML : ISellerML
    {
        ...
        #endregion
        #region UPIPayement
        public MDMTResponse DoUPIPayment(ReqSendMoney reqSendMoney)
        {
            var resp = new MDMTResponse
            {
                Statuscode = RechargeRespType.PENDING,
        ...
        public ValidateOuletModel CheckOnboardUser(int OID, string OTP)
        {
            ...
            if (_lr.LoginTypeID == LoginType.ApplicationUser && _lr.RoleID == Role.Retailor_Seller)
            {
                ...
                resp = BBPSML.CheckOutletStatusForServices(_lr.LoginTypeID, _lr.UserID, OID, _lr.OutletID, string.Empty, OTP, RequestMode.PANEL, 0, string.Empty);
            }
            return resp;
        }
        #endregion
