...
namespace RoundpayFinTech.AppCode
{
    ...
    public class UserML : IUserML, IFundProcessML, IKYCML, IAdminML, IUserAPPML, IAPIUserML, IIPAddressML, IUserWebsite
    {
        ...
        public ResponseStatus CallSignup(ExchangeUser _req)
        {
            var _resp = new ResponseStatus
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public List<MasterCompanyType> GetCompanyTypeMaster()
        {
            ...
            if (_lr.LoginTypeID == LoginType.ApplicationUser)
            {
                ...
                bankMasters = (List<MasterCompanyType>)_proc.Call(commonReq);
            }
            return bankMasters;
        }
        ...
        public IResponseStatus UpdateAutoBilling(AutoBillingModel req)
        {
            ...
            if (_lr == null && req.LT == LoginType.ApplicationUser)
            {
            ...
            else if (_lr.LoginTypeID == LoginType.ApplicationUser && _lr.RoleID.In(Role.Admin, Role.MasterWL))
            {
                req.LoginID = _lr.UserID;
                req.LT = _lr.LoginTypeID;
                req.Browser = _rinfo.GetBrowserFullInfo();
        ...
        public GetAddService GetAddServiceSts(int LT, int userid)
        {
        ...
        public ResponseStatus ActivateAddServiceSts(int LT, int userid, int outletId, int opTypeId, int oid)
        {
            ...
            var _ = (GetAddService)proc.Call(new ActAddonSerReq
            {
                LoginTypeID = LT,
                LoginID = userid,
                OutletID = outletId,
