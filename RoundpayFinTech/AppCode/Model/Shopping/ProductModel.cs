...
namespace RoundpayFinTech.AppCode.Model.Shopping
{
    ...
    {
        public IEnumerable<ShoppingCategory> Category { get; set; }
        public IEnumerable<ShoppingSubCategoryLvl1> SubCategoryLvl1 { get; set; }
        public IEnumerable<ShoppingSubCategoryLvl2> SubCategoryLvl2 { get; set; }
