...
namespace RoundpayFinTech.AppCode.ThirdParty.AggrePay
{
    public class AggrePayML
    {
        ...
        public PGModelForRedirection GeneratePGRequestForApp(PGTransactionResponse pGTransactionResponse, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new PGModelForRedirection
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public AggrePayResponseData StatusCheckPG(TransactionPGLog transactionPGLog, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
