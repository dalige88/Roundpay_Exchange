    ...
    public class BillAvenueML
    {
        ...
        public BBPSResponse BillFetchAPI(BBPSLog bbpsLog)
        {
            ...
            var req = new BABillFetchRequest
            {
                ...
                agentId = (bbpsLog.APIReqHelper.InitChanel ?? string.Empty).StartsWith("INT") ? bbpsLog.aPIDetail.OnlineOutletID : apiSetting.agentId,
        ...
        public HitRequestResponseModel BillPayement(BBPSPaymentRequest bBPSRequest)
        {
            ...
            try
            {
                ...
                {
                    amount = (bBPSRequest.RequestedAmount * 100).ToString().Replace(".00",""),
                    currency = "356",
