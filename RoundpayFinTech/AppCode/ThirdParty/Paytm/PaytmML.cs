...
namespace RoundpayFinTech.AppCode.ThirdParty.Paytm
{
    public partial class PaytmML
    {
        ...
        public PGModelForRedirection GeneratePGRequestForWeb(PGTransactionResponse pGTransactionResponse, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
        ...
        public PGModelForRedirection GeneratePGRequestForJS(PGTransactionResponse pGTransactionResponse, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var res = new PGModelForRedirection
            {
                Statuscode = ErrorCodes.Minus1,
        ...
        public void GeneratePGRequestForJSApp(PGTransactionResponse pGTransactionResponse, PGModelForApp res, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var paytmPGRequest = new PaytmPGRequest
            {
                MID = pGTransactionResponse.MerchantID,
        ...
        public void GeneratePGRequestForApp(PGTransactionResponse pGTransactionResponse, PGModelForApp res, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var paytmPGRequest = new PaytmPGRequest
            {
                MID = pGTransactionResponse.MerchantID,
        ...
        public PaytmPGResponse StatusCheckPG(TransactionPGLog transactionPGLog, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
        ...
        public PaytmPGResponse StatusCheckPGJS(TransactionPGLog transactionPGLog, Func<int, int, string, string, string, int, bool, int, string, Task> savePGTransactionLog)
        {
            var payresp = new PaytmPGResponse();
            var res = new PGModelForRedirection
            {
