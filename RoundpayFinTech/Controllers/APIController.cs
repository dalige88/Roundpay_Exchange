...
namespace RoundpayFinTech.Controllers
{
    public partial class APIController : Controller, ITransactionService
    {
        ...
        public IActionResult CheckIPGeoInfo([FromBody] ApiIPGeoLocInfoReq apiIPGeoLocInfoReq)
        {
            ...
            Task<ResponseStatus> taskUserAuth = reportML.AuthenticateAPIReqForIPGeoInfo(apiIPGeoLocInfoReq.UserID, apiIPGeoLocInfoReq.Token);
            var userAuth = taskUserAuth.Result;
