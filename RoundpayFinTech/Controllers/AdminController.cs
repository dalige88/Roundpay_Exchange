    ...
    public partial class AdminController : Controller
    {
        ...
        public IActionResult BulkNotification(IFormFile file, string Title, string Url, string Message, bool IsWebNotify, string Operators = "", string Roles = "")
        {
            ...
            if (IsWebNotify)
            {
                ...
                if (resp.Statuscode == ErrorCodes.One)
                {
                    ...
                    Parallel.Invoke(async () => await alertMl.BulkWebNotification(alertParam).ConfigureAwait(false));
        ...
        public IActionResult _FundTransfer(int pid, int uid)
        {
            ...
            else
            {
                ...
                ViewBag.CanDebit = _lr.LoginTypeID==1?true:res.Candebit;
...
= uidList;
        ...
        [Route("get-add-serv")]
        public IActionResult GetAddService(int UID)
        {
            var userML = new UserML(_accessor, _env);
            var res = userML.GetAddServiceSts(_lr.LoginTypeID, UID);
        ...
        [Route("act-add-serv")]
        public IActionResult ActAddService(int outletId, int opTypeId, int OID)
        {
            var userML = new UserML(_accessor, _env);
            var res = userML.ActivateAddServiceSts(_lr.LoginTypeID, _lr.UserID, outletId, opTypeId, OID);
            return Json(res);
        }
        #endregion
