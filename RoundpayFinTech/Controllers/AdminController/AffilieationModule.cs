...
namespace RoundpayFinTech.Controllers
{
    public partial class AdminController
    {
        ...
        public IActionResult AddAffiliatedItems(int VendorID, string Link, string ImgUrl, bool IsActive, int ID, int LinkType, int OID, bool IsDel)
        {
            IAffiliationML ml = new AffiliationML(_accessor, _env);
            var res = ml.AddAffiliatedItems(VendorID, Link, ImgUrl, IsActive, ID, LinkType, OID, IsDel);
            return Json(res);
        }
