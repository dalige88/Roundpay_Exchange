...
namespace RoundpayFinTech.Controllers
{
    public partial class AdminController
    {
        ...
        public IActionResult ProfileUser()
        {
            ...
            IBankML bankML = new BankML(_accessor, _env);
            var banks = bankML.BankMasters();
            var CompanyType = userML.GetCompanyTypeMaster();
            if (banks.Any())
            {
                userData.Bankselect = new SelectList(banks, "BankName", "BankName");
            }
            ...
            string url = ApplicationSetting.IsAPIExchange ? "UserEdit/Exchange/UpdateProfile" : "UserEdit/UpdateProfile";
            return View(url, userData);
        }
        [HttpPost]
