...
namespace RoundpayFinTech.Controllers
{
    public class AdminShopping : BaseController
    {
        ...
        public IActionResult _FEImgUpadte(int id = 0)
        {
            ...
            res.Categories = mL.GetShoppingCategory();
        ...
        public IActionResult AddProduct(int ProductDetailID)
        {
            ...
            if (ProductDetailID > 0)
            {
                ...
                {
                    model.SubCategoryLvl1 = mL.GetSubCategoryLvl1(model.Detail.ProductDetail.CategoryID);
                    model.SubCategoryLvl2 = mL.GetSubCategoryLvl2(model.Detail.ProductDetail.SubCategoryID1);
        ...
        public IActionResult AddMasterProduct(int PID)
        {
            ...
            if (PID > 0)
            {
                model.SubCategoryLvl1 = mL.GetSubCategoryLvl1(model.MasterProductDetail.CategoryID);
                model.SubCategoryLvl2 = mL.GetSubCategoryLvl2(model.MasterProductDetail.SubCategoryID1);
            }
            return PartialView("Partial/_ProductMaster", model);
        }
        ...
        public IActionResult ListFilterOption(int CID, int sid, bool IsListForm = false)
        {
            IShoppingML mL = new ShoppingML(_accessor, _env);
        ...
        {
            IShoppingML mL = new ShoppingML(_accessor, _env);
            var Category = mL.GetShoppingCategory();
            if (LoginType.ApplicationUser == _lr.LoginTypeID && ApplicationSetting.IsECommerceAllowed)
        ...
        public IActionResult _ProductForIndex(ProductFilter p)
        {
            ...
            return PartialView("Partial/_ProductForIndex", res);
        }
        ...
        {
            IShoppingML mL = new ShoppingML(_accessor, _env);
            var subCategoryLvl2 = mL.GetSubCategoryLvl2();
        ...
        public IActionResult Brand(int Id = 0)
        {
            ...
            model.Categories = mL.GetShoppingCategory();
