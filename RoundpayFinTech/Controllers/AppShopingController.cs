...
namespace RoundpayFinTech.Controllers
{
    public partial class AppController : IAppControllerShoping
    {
        ...
        [HttpPost]
        public async Task<IActionResult> ProceedToPay([FromBody] AppSessionReq appRequest)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetShippingAddresses([FromBody] AppSessionReq appRequest)
        {
        ...
        public async Task<IActionResult> AllAvailableFilter([FromBody] AllAvailableFilterReq appRequest)
        {
            ...
            if (ApplicationSetting.IsECommerceAllowed)
            {
                ...
                if (appResp.Statuscode == ErrorCodes.One)
                {
                    ...
                    {
                        IShoppingML ml = new ShoppingML(_accessor, _env);
                        Response.Filters = ml.GetRequeiredFilter(appRequest.S2ID, appRequest.S2ID != 0 ? 0 : appRequest.SID);
        ...
        [HttpPost]
        public async Task<IActionResult> GetStates([FromBody] AppRequest appRequest)
        {
