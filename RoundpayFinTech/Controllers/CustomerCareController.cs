...
namespace RoundpayFinTech.Controllers
{
    public class CustomerCareController : Controller
    {
        ...
        [Route("WpChatArea")]
        public IActionResult WpChatArea(string Mobile, int AID,int sndnoid)
        {
            IWhatsappML whatsappML = new WhatsappML(_accessor, _env);
        ...
        [Route("ContactSearch")]
        public IActionResult ContactSearch(string SearchValue, int Usmsgs, int sid, bool isFirstCall = true)
        {
            IWhatsappML whatsappML = new WhatsappML(_accessor, _env);
            var _req = new CommonReq
            {
        ...
        public async Task<IActionResult> SendForwardMessage(string CTS)
        {
            ...
            await whatsappML.SendWhatsappForwardMessageAllAPI(CTS);
            return Json(1);
        }
        #endregion
