...
namespace RoundpayFinTech.Controllers
{
    public class LoginController : Controller
    {
        ...
        public IActionResult LoginCheck([FromBody] LoginDetail loginDetail)
        {
            ...
            return Json(new { responseStatus.Statuscode, responseStatus.Msg, Path = responseStatus.CommonStr, CommonBool = responseStatus.CommonBool });
        }
        ...
        [HttpPost]
        [Route("Signup")]
        public IActionResult Signup([FromBody] ExchangeUser UserCreate)
        {
            if (!ApplicationSetting.IsSingupPageOff)
            {
                UserCreate.RoleID = ApplicationSetting.IsAPIExchange ? Role.APIUser : UserCreate.RoleID;
