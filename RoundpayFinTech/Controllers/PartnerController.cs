    ...
    public class PartnerController : Controller
    {
        ...
        public async Task<IActionResult> _GetBalance(string PidData, string aadhar, string bank, int t,string _lat,string _long)
        {
            ...
            if (aEPSURLSessionResp != null)
            {
                ...
                return Json(await deviceMl.CheckBalance(pidData, aadhar, bank, t, aEPSURLSessionResp.APIUserID, aEPSURLSessionResp.OutletID, RequestMode.PARTNERPANEL, 0,string.Empty,_lat,_long).ConfigureAwait(false));
            }
        ...
        public async Task<IActionResult> _WithDraw(string PidData, string aadhar, string bank, int t, int amount, string _lat, string _long)
        {
            ...
            if (aEPSURLSessionResp != null)
            {
                ...
                IDeviceML deviceMl = new DeviceML(_accessor, _env);
                return Json(await deviceMl.Withdrawl(pidData, aadhar, bank, t, amount, aEPSURLSessionResp.APIUserID, aEPSURLSessionResp.OutletID, RequestMode.PARTNERPANEL, 0, string.Empty, _lat, _long).ConfigureAwait(false));
            }
            return Json(new { Statuscode = ErrorCodes.Minus1, Msg = ErrorCodes.InvaildSession });
        }
        [HttpPost]
        ...
        public async Task<IActionResult> Aadharpay(string PidData, string aadhar, string bank, int t, int amount, string _lat, string _long)
        {
            ...
            if (aEPSURLSessionResp != null)
            {
                ...
                IDeviceML deviceMl = new DeviceML(_accessor, _env);
                return Json(await deviceMl.Aadharpay(pidData, aadhar, bank, t, amount, aEPSURLSessionResp.APIUserID, aEPSURLSessionResp.OutletID, RequestMode.PARTNERPANEL, 0, string.Empty, _lat, _long).ConfigureAwait(false));
            }
            return Json(new { Statuscode = ErrorCodes.Minus1, Msg = ErrorCodes.InvaildSession });
        }
        [HttpPost]
        ...
        public async Task<IActionResult> _MiniStatement(string PidData, string aadhar, string bank, string bankIIN, int t, string _lat, string _long)
        {
            ...
            if (aEPSURLSessionResp != null)
            {
                ...
                IDeviceML deviceMl = new DeviceML(_accessor, _env);
                return PartialView("Partial/_MiniStatement", deviceMl.MiniStatement(pidData, aadhar, bank, bankIIN, t, aEPSURLSessionResp.APIUserID, aEPSURLSessionResp.OutletID, RequestMode.PARTNERPANEL, 0, SPKeys.AepsMiniStatement, string.Empty, _lat, _long));
            }
            return Json(new { Statuscode = ErrorCodes.Minus1, Msg = ErrorCodes.InvaildSession });
        }
        [HttpPost]
