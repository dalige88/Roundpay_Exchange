...
namespace RoundpayFinTech.Controllers
{
    public partial class SellerController : Controller
    {
        ...
        #endregion
        public SellerController(IHttpContextAccessor accessor, IHostingEnvironment env, IEFTCommonH IEFTCommonH)
        {
            _accessor = accessor;
            _env = env;
        ...
        public async Task<IActionResult> _MiniStatement(string PidData, string aadhar, string bank, string bankIIN, int t, string _lat, string _long)
        {
            ...
            return PartialView("Partial/AEPS/_MiniStatement", deviceMl.MiniStatement(pidData, aadhar, bank, bankIIN, t, _lr.UserID, _lr.OutletID, RequestMode.PANEL, 0, SPKeys.AepsMiniStatement, string.Empty, _lat, _long));
        }
        ...
        public IActionResult RechSimpPlans(int o, int c)
        {
            ...
            {
                var plansAPIML = new PlansAPIML(_accessor, _env, _IEFTCommonH);
        ...
        [HttpPost]
        [Route("OnBoradUser")]
        public IActionResult OnboardUserRequest(int ID, string OTP)
        {
            ISellerML sellerML = new SellerML(_accessor, _env);
            var _res = sellerML.CheckOnboardUser(ID, OTP);
